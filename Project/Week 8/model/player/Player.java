package Serie_8.project.model.player;

import Serie_8.project.model.Attacker;
import Serie_8.project.model.Direction;
import Serie_8.project.model.Hittable;
import Serie_8.project.model.Moveable;
import Serie_8.project.model.shot.Bullet;
import Serie_8.project.model.shot.Shot;
import Serie_8.project.util.MyLinkedList;
import Serie_8.project.view.Sprite;
import Serie_8.project.util.Point;
import Serie_8.project.util.Vector;
...
public class Player extends Sprite implements Hittable, Moveable, Attacker {
    ...
    public Player(Point pos) throws IOException {
        super(ImageIO.read(Player.class.getResource("/Serie_8/project/resources/player.png")),
                pos);
    }
